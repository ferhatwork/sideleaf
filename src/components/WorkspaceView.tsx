    ...
    <div className="max-w-3xl mx-auto py-6 px-4 space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-neutral-200/60 dark:border-neutral-800/80 pb-2">
        ...
        <span className="text-[11px] font-mono text-neutral-400">
          {workspaceItems.length} {locale === 'tr' ? 'öğe' : 'items'}
        </span>
      </div>
          ...
          {workspaceItems.length > visibleCount && (
            <div className="pt-4 text-center">
              ...
              >
                <span>
                  {locale === 'tr'
                    ? `Daha fazla göster (${workspaceItems.length - visibleCount} kaldı)`
                    : `Show more (${workspaceItems.length - visibleCount} remaining)`}
                </span>
