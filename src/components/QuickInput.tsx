...
import { Type, CheckSquare, Quote, Link2, ArrowRight } from 'lucide-react';
...
export const QuickInput: React.FC<QuickInputProps> = ({
  ...
  placeholder = "Write it down... (Enter to save, Shift+Enter for new line)",
}) => {
  ...
  return (
    <div className="rounded-xl border border-neutral-300/80 dark:border-workpad-dark-border bg-white dark:bg-workpad-dark-surface shadow-sm focus-within:border-blue-500/70 dark:focus-within:border-blue-500/60 focus-within:ring-1 focus-within:ring-blue-500/30 transition-all p-3">
      <textarea
        ref={textareaRef}
        value={content}
        onChange={(e) => {
